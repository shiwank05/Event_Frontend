            ...
            {isLoggedIn ? (
              <>
                ...
                <div className="flex items-center ml-4 pl-4 border-l border-gray-700">
                  <span className="text-sm font-medium text-gray-300 mr-4">Hello, {userName}</span>
                  <button
              ...
              <>
                ...
                <Link 
                  to="/signup" 
                  className="ml-2 bg-blue-600 px-4 py-2 rounded-md text-sm font-medium hover:bg-blue-700 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                >
                  Signup
                </Link>
              </>
